...
set C_modelArgList {
	...
	{ AXI_video_strm_V_data_V int 24 regular {axi_s 1 volatile  { output_r Data } }  }
	{ AXI_video_strm_V_keep_V int 3 regular {axi_s 1 volatile  { output_r Keep } }  }
	{ AXI_video_strm_V_strb_V int 3 regular {axi_s 1 volatile  { output_r Strb } }  }
	{ AXI_video_strm_V_user_V int 1 regular {axi_s 1 volatile  { output_r User } }  }
	{ AXI_video_strm_V_last_V int 1 regular {axi_s 1 volatile  { output_r Last } }  }
	{ AXI_video_strm_V_id_V int 1 regular {axi_s 1 volatile  { output_r ID } }  }
	{ AXI_video_strm_V_dest_V int 1 regular {axi_s 1 volatile  { output_r Dest } }  }
}
...
set portList { 
	...
	{ output_r_TDATA sc_out sc_lv 24 signal 5 } 
	{ output_r_TVALID sc_out sc_logic 1 outvld 11 } 
	{ output_r_TREADY sc_in sc_logic 1 outacc 5 } 
	{ output_r_TKEEP sc_out sc_lv 3 signal 6 } 
	{ output_r_TSTRB sc_out sc_lv 3 signal 7 } 
	{ output_r_TUSER sc_out sc_lv 1 signal 8 } 
	{ output_r_TLAST sc_out sc_lv 1 signal 9 } 
	{ output_r_TID sc_out sc_lv 1 signal 10 } 
	{ output_r_TDEST sc_out sc_lv 1 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_r_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "output_r_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "output_r_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "output_r_TKEEP", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_keep_V", "role": "default" }} , 
 	{ "name": "output_r_TSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_strb_V", "role": "default" }} , 
 	{ "name": "output_r_TUSER", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_user_V", "role": "default" }} , 
 	{ "name": "output_r_TLAST", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_last_V", "role": "default" }} , 
 	{ "name": "output_r_TID", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_id_V", "role": "default" }} , 
 	{ "name": "output_r_TDEST", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	AXI_video_strm_V_data_V { axis {  { output_r_TDATA out_data 1 24 }  { output_r_TREADY out_acc 0 1 } } }
	AXI_video_strm_V_keep_V { axis {  { output_r_TKEEP out_data 1 3 } } }
	AXI_video_strm_V_strb_V { axis {  { output_r_TSTRB out_data 1 3 } } }
	AXI_video_strm_V_user_V { axis {  { output_r_TUSER out_data 1 1 } } }
	AXI_video_strm_V_last_V { axis {  { output_r_TLAST out_data 1 1 } } }
	AXI_video_strm_V_id_V { axis {  { output_r_TID out_data 1 1 } } }
	AXI_video_strm_V_dest_V { axis {  { output_r_TVALID out_vld 1 1 }  { output_r_TDEST out_data 1 1 } } }
}
