...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {8 0 +} m {16 0 +} i2 {16 0 +} p {16 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {6 0 +} m {14 0 +} i2 {16 0 +} p {16 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {7 1 +} m {15 1 +} i2 {15 0 +} p {16 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_r_low \
    op interface \
    ports { r_low_dout { I 32 vector } r_low_empty_n { I 1 bit } r_low_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_r_up \
    op interface \
    ports { r_up_dout { I 32 vector } r_up_empty_n { I 1 bit } r_up_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_g_low \
    op interface \
    ports { g_low_dout { I 32 vector } g_low_empty_n { I 1 bit } g_low_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_g_up \
    op interface \
    ports { g_up_dout { I 32 vector } g_up_empty_n { I 1 bit } g_up_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_b_low \
    op interface \
    ports { b_low_dout { I 32 vector } b_low_empty_n { I 1 bit } b_low_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_b_up \
    op interface \
    ports { b_up_dout { I 32 vector } b_up_empty_n { I 1 bit } b_up_read { O 1 bit } } \
} "
}
