...
// ==============================================================
#ifndef __fire_mac_muladd_8cud__HH__
#define __fire_mac_muladd_8cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fire_mac_muladd_8cud) {
    ...
    SC_CTOR(fire_mac_muladd_8cud):  simcore_mac_1_U ("simcore_mac_1_U") {
