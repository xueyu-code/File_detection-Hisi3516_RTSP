...
// ==============================================================
#ifndef __fire_mac_muladd_8dEe__HH__
#define __fire_mac_muladd_8dEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fire_mac_muladd_8dEe) {
    ...
    SC_CTOR(fire_mac_muladd_8dEe):  simcore_mac_2_U ("simcore_mac_2_U") {
