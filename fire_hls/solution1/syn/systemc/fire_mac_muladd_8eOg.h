...
// ==============================================================
#ifndef __fire_mac_muladd_8eOg__HH__
#define __fire_mac_muladd_8eOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fire_mac_muladd_8eOg) {
    ...
    SC_CTOR(fire_mac_muladd_8eOg):  simcore_mac_3_U ("simcore_mac_3_U") {
