...
set Interfaces {
    ...
    s_axi_MATRIX_BUS {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_MATRIX_BUS"
        param_prefix "C_S_AXI_MATRIX_BUS"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {}
        memories "matrix {base_address 16 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS s_axi_MATRIX_BUS inStream outStream"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 7077892 II x}
