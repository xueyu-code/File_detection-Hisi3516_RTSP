...
proc create_root_design { parentCell } {
  ...
  # Create instance: fire_0, and set properties
  set fire_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:fire:1.0 fire_0 ]

  # Create instance: ov5640_driver_0, and set properties
  set ov5640_driver_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ov5640_driver:1.0 ov5640_driver_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_APU_PERIPHERAL_FREQMHZ {766} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#unassigned#unassigned#UART 1#UART 1#unassigned#unassigned#unassigned#unassigned} \
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins fire_0/input_r]
  ...
  connect_bd_intf_net -intf_net fire_0_output_r [get_bd_intf_pins axi_vdma_1/S_AXIS_S2MM] [get_bd_intf_pins fire_0/output_r]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins fire_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net Net [get_bd_ports cmos_sda] [get_bd_pins ov5640_driver_0/cmos_sda]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins util_vector_logic_1/Op1] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/resetn]
  connect_bd_net -net cmos_data_0_1 [get_bd_ports cmos_data] [get_bd_pins ov5640_driver_0/cmos_data]
  connect_bd_net -net cmos_href_0_1 [get_bd_ports cmos_href] [get_bd_pins ov5640_driver_0/cmos_href]
  connect_bd_net -net cmos_pclk_0_1 [get_bd_ports cmos_pclk] [get_bd_pins ov5640_driver_0/cmos_pclk]
  connect_bd_net -net cmos_vsync_0_1 [get_bd_ports cmos_vsync] [get_bd_pins ov5640_driver_0/cmos_vsync]
  connect_bd_net -net ov5640_driver_0_cmos_clk_en [get_bd_pins ov5640_driver_0/cmos_clk_en] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net ov5640_driver_0_cmos_rstn [get_bd_ports cmos_rst_n] [get_bd_pins ov5640_driver_0/cmos_rstn]
  connect_bd_net -net ov5640_driver_0_cmos_scl [get_bd_ports cmos_scl] [get_bd_pins ov5640_driver_0/cmos_scl]
  connect_bd_net -net ov5640_driver_0_data_valid [get_bd_pins ov5640_driver_0/data_valid] [get_bd_pins v_vid_in_axi4s_0/vid_active_video]
  connect_bd_net -net ov5640_driver_0_pclk [get_bd_pins ov5640_driver_0/pclk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net ov5640_driver_0_rgb_data [get_bd_pins ov5640_driver_0/rgb_data] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net ov5640_driver_0_vsync [get_bd_pins ov5640_driver_0/vsync] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_1/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins fire_0/ap_clk] [get_bd_pins ov5640_driver_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins fire_0/ap_rst_n] [get_bd_pins ov5640_driver_0/rstn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fire_0/s_axi_AXILiteS/Reg] SEG_fire_0_Reg
